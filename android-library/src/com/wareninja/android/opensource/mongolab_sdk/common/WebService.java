...
public class WebService {
	...
	public void addRequestHeader(final String key, final String value) {
		...
		if (AppContext.isDebugMode()) Log.d(TAG, "addRequestHeader->" + "key:" + key + "|value:" + value);
	...
	public String webInvokePOST(String methodName, String data,
			String contentType) {
		ret = null;
		...
		if (AppContext.isDebugMode()) Log.d(TAG, "webInvokePOST -> " + webServiceUrl+methodName + " |Êdata: " + data);
		...
		try {
			...
			if (response.getStatusLine()!=null) mHttpResponseCode = response.getStatusLine().getStatusCode();
		} catch (Exception e) {
	...
	public String webGet(String methodName, Map<String, String> params) {
		...
		if (AppContext.isDebugMode()) Log.d(TAG, "WebGetURL: " + getUrl);
	...
	public String webPost(String methodName, Bundle params)
		...
		if (AppContext.isDebugMode()) Log.d(TAG, "POST URL: " + postUrl);
		...
		//if ( TextUtils.isEmpty(conn.getRequestProperty("User-Agent")) ) {
			conn.setRequestProperty("User-Agent", System.getProperties()
					.getProperty("http.agent") + " WareNinjaAndroidSDK"//"com.wareninja.android.mayormonster"//CommonUtils.getMyUserAgent(mContext)//
					);
		//}
